...
public class StudentDataAccessService {
    ...
    public List<StudentCourse> selectAllStudentsCourses(UUID studentId) {
        String sql = "" +
                ...
                " USING (student_id) JOIN course " +
                " USING (course_id) WHERE student.student_id = ?";
    ...
    int insertStudent(UUID studentId, Student student) {
        ...
        int update = jdbcTemplate.update(sql, studentId, student.getFirstName(), student.getLastName(), student.getEmail(), student.getGender().name().toUpperCase());
    ...
    private RowMapper<StudentCourse> mapStudentCourseFromDB() {
        return (resultSet,i) ->
                new StudentCourse(UUID.fromString(resultSet.getString("student_id")), UUID.fromString(resultSet.getString("course_id")), resultSet.getString("name"), resultSet.getString("description"), resultSet.getString("departement"), resultSet.getString("teacher_name"),
